...
long MAXPARAGRAPH_SIZE = 50; //50; // max number of words in a paragraph.
long MINPARAGRAPH_SIZE = 30; // min number of words in a paragraph before we process it.

double TERMFREQ_FROM = 0.002;// 0.001;
double TERMFREQ_TO = 0.35; //0.3;

double DOCFREQ_FROM = 0.03;
double DOCFREQ_TO = 1.0;

long DOCFREQMINCOUNT = 1;
